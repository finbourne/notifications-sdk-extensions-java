...
import static com.finbourne.notifications.extensions.TestContants.DUMMY_CREDENTIALS_FILE;
...
public class ApiConfigurationBuilderTests {
    ...
    public void build_WithUnsetEnvironmentVariables_ShouldGetFromFile() throws ApiConfigurationException {
        ...
        assertThat(apiConfiguration.getApiUrl(), equalTo("https://some-non-existing-test-instance.lusid.com/notifications"));
    ...
    ApiConfiguration validConfigFromEnvVariables(){
        return new ApiConfiguration("https://some-non-existing-test-instance.doesnotexist.com/oauth2/doesnotexist/v1/token","user","pass","client-id-from-env","secret-from-env","https://some-non-existing-test-instance.lusid.com/notifications","non-existent",null,null,null,null);
    }
